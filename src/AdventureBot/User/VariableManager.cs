...
{
    [Key("ItemVariables")] private Dictionary<string, VariableContainer> _itemVariables = new();

    [Key("QuestVariables")] private Dictionary<string, Dictionary<Guid, VariableContainer>> _questVariables = new();

    [Key("RoomVariables")] private Dictionary<string, VariableContainer> _roomVariables = new();

    [Key(nameof(PersistentVariables))] public VariableContainer PersistentVariables = new();

    [Key(nameof(UserVariables))] public VariableContainer UserVariables = new();
