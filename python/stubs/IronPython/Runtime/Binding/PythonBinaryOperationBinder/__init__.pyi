...
class LightThrowBinder(IronPython.Runtime.Binding.IPythonSite, Microsoft.Scripting.Runtime.IExpressionSerializable, Microsoft.Scripting.Actions.ILightExceptionBinder, IronPython.Runtime.Binding.PythonBinaryOperationBinder):
    @typing.overload
    ...
    # methods
    def __init__(self, context: IronPython.Runtime.PythonContext, operation: int, ):
        ...
