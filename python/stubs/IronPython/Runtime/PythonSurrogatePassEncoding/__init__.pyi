...
class SurrogatePassEncoderFallbackBuffer(IronPython.Runtime.PythonEncoding.PythonEncoderFallbackBuffer):
    @typing.overload
...
class SurrogatePassEncoderFallback(System.ICloneable, IronPython.Runtime.PythonEncoding.PythonEncoderFallback):
    @typing.overload
    def __init__(self, **kwargs):
        ...
...
class SurrogatePassDecoderFallbackBuffer(IronPython.Runtime.PythonEncoding.PythonDecoderFallbackBuffer):
    @typing.overload
    def __init__(self, **kwargs):
    ...
    def Throw(self, bytesUnknown: System.Array[int], index: int, ) -> None:
        ...

class SurrogatePassDecoderFallback(System.ICloneable, IronPython.Runtime.PythonEncoding.PythonDecoderFallback):
    @typing.overload
    def __init__(self, **kwargs):
        ...
